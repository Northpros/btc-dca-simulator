...
export default function DCASimulator() {
  ...
  const InfoTip = ({ text, align }) => (
    <span className="info-tip">
      <span className="info-icon" style={{ color: darkMode ? "#7788aa" : "#667", border: `1px solid ${darkMode ? "#3a3a5a" : T.border2}` }}>ⓘ</span>
    ...
    <div style={{ background: T.bg, minHeight: "100vh", color: T.text, fontFamily: "'DM Mono', monospace", padding: "24px 28px" }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .info-tip .info-icon { font-size: 10px; width: 14px; height: 14px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; opacity: 0.55; transition: opacity 0.2s; }
        .info-tip:hover .info-icon { opacity: 1; }
